...
(async () => {
  ...
  card.setConfig({ weather_entity: "weather.home", sun_entity: "sun.sun", minute_forecast_entity: "sensor.rain_minutes", temperature_entity: "sensor.outdoor_temperature" });
  ...
  card.hass = {
    ...
    states: {
      ...
      "sensor.rain_minutes": { state: "on", attributes: { forecast: [0, 0, 0, 0.2, 0.7, 0.3, 0] } },
